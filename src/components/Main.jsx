    ...
    return (
        <>
            <main className="w-90 mt-5 mx-auto">
                <section>
                    <img className="w-full" src={illustrationOne} alt="hero image" />
                ...
                <section>
                    <img className="w-full" src={illustrationTwo} alt="people picture" />
                    <h2 className="mt-8 mb-3 text-blue-300 text-md font-bold text-center">Stay productive, wherever you are</h2>
                    <div className="flex flex-col gap-y-2.5 text-sm text-blue">
                        <p>
                    ...
                    <a className="mt-6 mb-8 flex items-center justify-center gap-x-1 text-sm text-cyan underline underline-offset-8 decoration-cyan" href="#">
                        See how Fylo works
                    ...
                    <article className="w-3/4 mx-auto mb-10">
                        <figure>
                            ...
                            <figcaption className="mt-0.5 mb-2 text-xs text-blue-300 leading-relaxed text-justify">
                                Fylo has improved our team productivity by an order of magnitude. Since
                                making the switch our team has become a well-oiled collaboration machine.
                            </figcaption>
                        </figure>
                        <figure className="flex items-center gap-x-1">
                            <img className="w-3.5 rounded-full" src={user} alt="user picture" />
                            <figcaption>
                                <h3 className="text-blue-300 font-bold text-xs">Kyle Burton</h3>
                                <p className="text-blue text-[1rem]">Founder & CEO, Huddle</p>
                            </figcaption>
                        </figure>
                    </article>
                </section>
